...
describe('Wallet', () => {
        ...
        describe('the chain is passed', () => {
          it('calls `Wallet.calculateBalance`', () => {
            ...
            wallet.createTransaction({ 
              recipient: 'foo', amount: 10, chain: new Blockchain().chain
            });
    ...
    describe('calculateBalance()', () => {
      ...
      describe('and there are outputs for the wallet', () => {
        ...
        describe('adn the wallet has made a transaction', () => {
          ...
          it('returns the outptu aount of the recent trasnaction', () => {
            ...
            describe('and there are outputs next to and after recent transaction', () => {
              ...
              nextBlockTransaction - new Wallet().createTransaction9({ recipient: wallet.publicKey, amount: 75 });
